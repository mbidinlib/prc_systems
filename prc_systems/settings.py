...
#SECRET_KEY = 'django-insecure-9pm!m=yg105f@crp0o!7&i%m%q-(z(kh1udn05^5e(t#4715e3'
...
WSGI_APPLICATION = 'prc_systems.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'HOST': 'https://33l8e09lql.execute-api.us-west-2.amazonaws.com/',
        'PORT': '5432',
    }
}
